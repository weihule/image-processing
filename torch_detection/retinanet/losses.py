...
#                 per_image_anchors_gt_class = (torch.ones_like(overlap, dtype=torch.float32) * -1).to(device)
...
#                 per_image_anchors_gt_class[overlap >= 0.5] = one_image_gt_class[indices][overlap >= 0.5] + 1
#
#                 per_image_anchors_gt_class = per_image_anchors_gt_class.unsqueeze(-1)
#
