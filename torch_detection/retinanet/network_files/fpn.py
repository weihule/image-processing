...
# class FPN(nn.Module):
#     def __init__(self, c3_in_channels, c4_in_channels, c5_in_channels, out_channels, use_p5=True):
#         super(FPN, self).__init__()
#         # inplanes:[C3_inplanes,C4_inplanes,C5_inplanes]
#         inplanes = [c3_in_channels, c4_in_channels, c5_in_channels]
...
#                               stride=1,
#                               padding=0)
#         self.P3_2 = nn.Conv2d(self.planes,
#                               self.planes,
#                               kernel_size=3,
#                               stride=1,
#                               padding=1)
...
#                               stride=1,
#                               padding=0)
#         self.P4_2 = nn.Conv2d(self.planes,
#                               self.planes,
#                               kernel_size=3,
#                               stride=1,
#                               padding=1)
...
#                               stride=1,
#                               padding=0)
#         self.P5_2 = nn.Conv2d(self.planes,
#                               self.planes,
#                               kernel_size=3,
#                               stride=1,
#                               padding=1)
#
#         self.P6 = nn.Conv2d(
#             self.planes, self.planes, kernel_size=3, stride=2,
#             padding=1) if self.use_p5 else nn.Conv2d(
#             inplanes[2], self.planes, kernel_size=3, stride=2,
#             padding=1)
#
#         self.P7 = nn.Sequential(
#             nn.ReLU(),
#             nn.Conv2d(self.planes, self.planes, kernel_size=3, stride=2, padding=1))
#
#     def forward(self, inputs):
#         [C3, C4, C5] = inputs
#
