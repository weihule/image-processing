...
class RetinaAnchor:
    ...
    def __call__(self, fpn_feature_sizes):
        ...
        Args:
            fpn_feature_sizes: if input_size: 640*640, [[w1, h1], ...]
            [[80, 80], [40, 40], [20, 20], ...]
        Returns:
    ...
    def generate_base_anchors(self, area, scales, ratios):
        ...
        Args:
            area: [32,32] or [64,64] or [128,128] or ...
            scales: (2 ** 0, 2 ** (1.0 / 3.0), 2 ** (2.0 / 3.0))
            ratios: (0.5, 1, 2)
        Returns:
        """
        ...
        # base_anchors format: [x_min,y_min,x_max,y_max],
        # center point:[0,0],shape[9,4]
    ...
    def generate_anchors_on_feature_map(self,
                                        base_anchors,
                                        feature_map_size,
                                        stride):
        """
        ...
        Args:
            base_anchors: shape is [9, 4]
            feature_map_size: [80, 80] or [40, 40]
            stride: 8 or 16 or 32 对应每个feature_map_size，
                    如8就对应[80, 80]
...
if __name__ == "__main__":
    ret = RetinaAnchor()
    ans = ret([[80, 80], [40, 40], [20, 20], [10, 10], [5, 5]])
    for i in ans:
        print(i.shape)
