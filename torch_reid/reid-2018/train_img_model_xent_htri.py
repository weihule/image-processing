...
def train(epoch, model, criterion_xent, criterion_htri, optimizer, trainloader, use_gpu, args):
    losses = AverageMeter()
...
def study_test(args):
    ...
    for idx, p in enumerate(trainloader):
        print(idx+1, p[0].shape, p[1].shape, p[2].shape)
